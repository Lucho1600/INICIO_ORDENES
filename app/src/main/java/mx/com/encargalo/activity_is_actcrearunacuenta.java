...
public class activity_is_actcrearunacuenta extends AppCompatActivity{
    ...
    TextView is_cuctwterminosycondiciones;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        is_cuctwterminosycondiciones = findViewById(R.id.is_cuctwterminosycondiciones);
        ...
        is_cuctwterminosycondiciones.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void ejecutarServicio(String URL){
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                parametros.put("sp_perTipo",po.toString());
                parametros.put("sp_perNumeroCelular", is_numero_celular.getText().toString());
